...
class BesniSpider(scrapy.Spider):
    ...
    start_urls = [
        # Beleza
        'https://www.besni.com.br/s?q=Shampoo',
        'https://www.besni.com.br/s?q=condicionador',
        'https://www.besni.com.br/s?q=perfume',
        'https://www.besni.com.br/s?q=p%C3%B3+impacto',
        'https://www.besni.com.br/s?q=hidratante+facial',
    ]
