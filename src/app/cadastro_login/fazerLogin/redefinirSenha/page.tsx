...
const ResetPassword: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            toast.error('Erro ao alterar senha, tente novamente', { position: "bottom-left", autoClose: 5000, theme: "dark" });
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <header className="flex flex-col md:flex-row h-screen bg-white dark:bg-gray-900">
            <div className="flex-1 w-full h-full flex flex-col items-center justify-center">
                ...
                <div className="max-w-6xl mx-auto p-8">
                    ...
                    <p className="text-xl sm:text-xl md:text-2xl lg:text-2xl text-center mb-8 text-black dark:text-white">
                            ...
                            <div className="w-full px-3 relative mb-10">
                                <input
                                    ...
                                    className="py-3 sm:py-4 md:py-5 lg:py-5 pl-12 sm:pl-14 md:pl-16 lg:pl-20
                                        ...
                                        border-black bg-white dark:bg-gray-700 dark:text-white focus:outline-none shadow-md transition duration-500 ease-in-out"
                                />
                            </div>
                            {/* Nova Senha */}
                        ...
                        <div className="text-center">
                            <button
                                ...
                                className={`mt-4 py-3 sm:py-4 md:py-5 lg:py-6 px-6 sm:px-8 md:px-16 lg:px-28
                                    text-2xl rounded-full border-2 border-navigategreen text-navigategreen
                                    bg-transparent font-semibold transition duration-500 ease-in-out
                                    hover:bg-navigategreen hover:text-white dark:hover:bg-green-600 dark:hover:text-white`}
                            >
