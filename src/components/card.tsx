...
const card = () => {
  return (
    <section className="mx-auto justify-items-center justify-center gap-y-4 gap-x-16 mt-10 mb-5">
      <div className="w-64 bg-white shadow-md shadow-navigateblue rounded-xl duration-500 hover:scale-105 hover:shadow-xl border-2 border-navigateblue">
        ...
        <div className="py-4 px-5">
          <p className="text-sm text-black block capitalize">
