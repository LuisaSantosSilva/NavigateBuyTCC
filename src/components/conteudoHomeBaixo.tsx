  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center px-4 mt-8 mb-28">
        <div className="text-center flex flex-row max-[1016px]:hidden">
          <Animated
            initial={{ x: '101%' }}
            animate={{ x: 0 }}
            ...
            <div className="rounded-2xl p-16 px-20 text-white bg-gradient-to-r from-navigateblue to-navigategreen">
              ...
              <a href="https://sistemas.procon.sp.gov.br/evitesite/list/evitesites.php">
                <button type='submit' className="mt-4 sm:py-1 sm:px-16 text-lg rounded-full border-2 font-extrabold hover:bg-gray-300 hover:border-gray-300 bg-white text-navigategreen">
                  Lista do ProconSP
        ...
        <div className="mt-16 text-center flex flex-row max-[1016px]:hidden">
          ...
          <Animated
            ...
            <div className="rounded-2xl p-16 px-20 text-white bg-gradient-to-r from-navigateblue to-navigategreen">
              ...
              <a href="https://transparencyreport.google.com/safe-browsing/search">
                <button type='submit' className="mt-4 sm:py-1 sm:px-16 text-lg rounded-full border-2 shadow-sm font-extrabold hover:bg-gray-300 hover:border-gray-300 bg-white text-navigateblue">
        ...
        <div className="text-center flex flex-col min-[1016px]:hidden">
          <Animated
            initial={{ y: '101%' }}
            animate={{ y: 0 }}
            transition={{ duration: 1, type: 'spring', stiffness: 30 }}>
        ...
        <div className="mt-16 text-center flex flex-col min-[1016px]:hidden">
          <Animated
            initial={{ y: '101%' }}
            animate={{ y: 0 }}
            transition={{ duration: 1, type: 'spring', stiffness: 30 }}>
